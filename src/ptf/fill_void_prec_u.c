...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/01/24 10:31:42 by phanna            #+#    #+#             */
/*   Updated: 2019/01/24 11:08:18 by phanna           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

void	fill_void_prec_u(t_printf *box, t_check *flag, const char *str, int arg)
{
	...
	fill_void_prec_u2(box, flag, str, arg);
}
